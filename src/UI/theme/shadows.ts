...
export const shadows: Shadows = [
  ...
  "0px 8px 10px -5px rgba(0,0,0,0.05),0px 16px 24px 2p rgba(0,0,0,0.04),0px 6px 30px 5px rgba(0,0,0,0.03)",
  "0px 8px 11px -5px rgba(0,0,0,0.05),0px 17px 26px 2p rgba(0,0,0,0.04),0px 6px 32px 5px rgba(0,0,0,0.03)",
  "0px 9px 11px -5px rgba(0,0,0,0.05),0px 18px 28px 2p rgba(0,0,0,0.04),0px 7px 34px 6px rgba(0,0,0,0.03)",
  "0px 9px 12px -6px rgba(0,0,0,0.05),0px 19px 29px 2p rgba(0,0,0,0.04),0px 7px 36px 6px rgba(0,0,0,0.03)",
  "0px 10px 13px -6px rgba(0,0,0,0.05),0px 20px 31px 3 rgba(0,0,0,0.04),0px 8px 38px 7px rgba(0,0,0,0.03)",
  "0px 10px 13px -6px rgba(0,0,0,0.05),0px 21px 33px 3 rgba(0,0,0,0.04),0px 8px 40px 7px rgba(0,0,0,0.03)",
  "0px 10px 14px -6px rgba(0,0,0,0.05),0px 22px 35px 3 rgba(0,0,0,0.04),0px 8px 42px 7px rgba(0,0,0,0.03)",
  "0px 11px 14px -7px rgba(0,0,0,0.05),0px 23px 36px 3 rgba(0,0,0,0.04),0px 9px 44px 8px rgba(0,0,0,0.03)",
  "0px 11px 15px -7px rgba(0,0,0,0.05),0px 24px 38px 3 rgba(0,0,0,0.04),0px 9px 46px 8px rgba(0,0,0,0.03)",
];
